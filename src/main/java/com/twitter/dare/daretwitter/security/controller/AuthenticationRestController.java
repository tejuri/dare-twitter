...
import com.twitter.dare.daretwitter.security.JwtAuthenticationRequest;
import com.twitter.dare.daretwitter.security.JwtTokenUtil;
import com.twitter.dare.daretwitter.security.JwtUser;
import com.twitter.dare.daretwitter.security.service.JwtAuthenticationResponse;
...
public class AuthenticationRestController {
	...
	public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtAuthenticationRequest authenticationRequest)
		...
		try {
			...
			// DEFAULT_strategyName = ThreadLocal which has fewer JVM
			// incompatibilities and is appropriate on servers.
