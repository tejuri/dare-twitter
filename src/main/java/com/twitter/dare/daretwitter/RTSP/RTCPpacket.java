...
class RTCPpacket {
	...
	public float fractionLost; // The fraction of RTP data packets from sender lost since the previous RR
								// packet was sent
	public int cumLost; // The total number of RTP data packets from sender that have been lost since
	...
	public String toString() {
		return "[RTCP] Version: " + Version + ", Fraction Lost: " + fractionLost + ", Cumulative Lost: " + cumLost
